...
import { getCompetition, type CompetitionInterface } from "api/competitions";
...
const PublicLink = ({
	...
	<div>
		...
		<p className="text-xs text-gray-400 mt-1.5">
			Share with participants to view standings and results
		</p>
	</div>
);
		...
		>
			...
			{activeTab === "teams" &&
				(selectedTeamId === null ? (
					<Teams
						competition={competition}
						onManagePlayers={setSelectedTeamId}
					/>
				) : (
					<TeamPlayers
