...
export default function CreateModal({
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			showToast(
				err?.response?.data?.message || "Competition creation failed.",
				false,
			);
		} finally {
			setIsLoading(false);
				...
				>
					...
					>
						...
						<p className="text-green-100 text-sm mt-1">
							Set up a new competition and start managing entries
						</p>
						<button
							onClick={onClose}
					...
					<form onSubmit={handleSubmit} className="p-8 space-y-6">
						...
						<div className="space-y-2">
							...
							<p className="text-xs text-gray-500">
								Use a descriptive name to identify this competition
							</p>
						</div>
						...
						<div className="space-y-2">
							...
							<p className="text-xs text-gray-500">
								Choose the type that best describes your competition
							</p>
						</div>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-xs text-gray-500 mt-1">
										{individual
											? "Competitors participate individually"
											: "Competitors participate in teams"}
									</p>
								</div>
								<button
									type="button"
