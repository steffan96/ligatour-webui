...
const LoginComponent = () => {
  ...
  const inputClass =
    'w-full px-8 py-3 rounded-md border border-gray-300 focus:border-green-900 ' +
    'focus:ring-2 focus:ring-green-200 focus:outline-none text-gray-800 bg-white ' +
    'shadow-sm transition duration-150';

  const buttonClass =
    'w-full py-2 rounded-md bg-green-900 hover:bg-green-900 text-white ' +
    ...
    <div className="flex flex-col items-center w-full p-8">
      ...
      <div className="flex flex-col items-center w-[95%] ml-auto p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-600 mt-6 text-center">
          ...
          <a href="/register" className="text-green-900 hover:underline font-medium">
            Register here
          </a>
        </p>
